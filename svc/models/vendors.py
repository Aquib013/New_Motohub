...
class Vendor(BaseModel):
    ...
    def update_vendor(self):
        ...
        # If total payments have fully covered POs + opening balance, clear the opening balance
        if total_payments >= total_po_amount + self.vendor_opening_balance:  # NOQA
            self.vendor_opening_balance = Decimal('0.00')

        self.vendor_balance = self.vendor_opening_balance + total_po_amount - total_payments
        ...
        if last_payment:
            ...
            self.last_payment_amount = Decimal('0.00')
